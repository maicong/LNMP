 ...
 * cookie
 */
$cfg['blowfish_secret'] = '739174021564331540'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['socket']        = '/home/userdata/mysql.sock';          // Path to the socket - leave blank for default socket
