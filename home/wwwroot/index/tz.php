...
/* ---------------------------------------------------- */
/* 
/* 因为 PHP7 已经抛弃了部分函数，所有麦葱对此做了修改。
/* mysql 对应函数改为 mysqli
/* eregi 改为 preg_match
/* mcrypt_cbc 改为 mcrypt_generic
/* 
/* ---------------------------------------------------- */
  ...
  if ($_POST['act'] == 'MySQL检测') {
  	...
  	if(function_exists("mysqli_close")==1) {
  		...
  		if ($link){
  			...
  			echo "<script>alert('连接到MySQL数据库正常，版本 v{$v}')</script>";
...
<table>
  ...
  ?>
	...
	<table>
		<tr>
			<td class="w_foot"><a href="https://maicong.me/2015-09-15-mc-lnmp.html" target="_blank"><?php echo $title.$version;?></A></td>
